...
👉 [github.com/ajth-in/nextjs-mswjs](https://github.com/ajth-in/nextjs-mswjs)
...
`mocks/data/github-user.json`: Now let's mock the GitHub API call we used earlier. We'll return a static user response from a local JSON file.
