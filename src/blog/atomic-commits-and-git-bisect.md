...
summary: "A small change can have an outsized impact. When our TypeScript typecheck slowed from a minute to several minutes, I turned to git bisect to narrow it down. How clean, atomic commits made the difference between a day of hunting and a 10-minute fix. The actual process with a real example from work."
---
