...
export function BlogCard({ post, className = "" }: BlogCardProps) {
  ...
  return (
    <div
      className={`group relative flex flex-row items-stretch gap-4 overflow-hidden 
        bg-white dark:bg-black text-neutral-50 border-4 dark:border-neutral-800 border-neutral-400
      ...
      <div className="flex flex-col justify-between p-3 flex-1 space-y-2">
        ...
        <div className="space-y-1">
          <Link
            ...
            className="block text-2xl font-monosans font-bold leading-snug line-clamp-2 text-black dark:text-white  transition-colors"
          >
